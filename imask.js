      ...
      },
      {
        ...
        value: function doPrepare(ch) {
          ...
          var _normalizePrepare = normalizePrepare(
            _get(_getPrototypeOf(MaskedRange.prototype), "doPrepare", this).call(this, ch.replace(/\D/g, ""), flags)
          );
      ...
      },
      {
        ...
        value: function doValidate() {
          ...
          return (
            ...
            (_get2 = _get(_getPrototypeOf(MaskedRange.prototype), "doValidate", this)).call.apply(_get2, [this].concat(args))
          );
        },
      },
    ]);
    ...
    _createClass(MaskedNumber, [
      ...
      },
      {
        ...
        value: function doPrepare(ch) {
          ...
          var _normalizePrepare = normalizePrepare(
              (_get2 = _get(_getPrototypeOf(MaskedNumber.prototype), "doPrepare", this)).call.apply(_get2, [this, noSepCh].concat(args))
            ),
      ...
      },
      {
        ...
        value: function extractInput() {
          ...
          return this._removeThousandsSeparators(
            _get(_getPrototypeOf(MaskedNumber.prototype), "extractInput", this).call(this, fromPos, toPos, flags)
          );
        },
        /**
	      @override
    ...
    _createClass(MaskedDynamic, [
      ...
      },
      {
        ...
        value: function doValidate() {
          ...
          return (
            (_get2 = _get(_getPrototypeOf(MaskedDynamic.prototype), "doValidate", this)).call.apply(_get2, [this].concat(args)) &&
            (!this.currentMask || (_this$currentMask = this.currentMask).doValidate.apply(_this$currentMask, args))
          );
        },
        /**
	      @override
      ...
      },
      {
        ...
        value: function extractTail() {
          ...
          return this.currentMask
            ? (_this$currentMask7 = this.currentMask).extractTail.apply(_this$currentMask7, args)
            : (_get3 = _get(_getPrototypeOf(MaskedDynamic.prototype), "extractTail", this)).call.apply(_get3, [this].concat(args));
        },
        /**
	      @override
	    */
